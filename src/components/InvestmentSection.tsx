...
import { CoinStackIllustration, ChartIllustration, WalletIllustration } from "./Illustrations3D";
        ...
        <div className="container mx-auto px-6" ref={ref}>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
            <motion.div
              ...
              className="shrink-0 order-2 lg:order-1 flex gap-4"
            >
              <CoinStackIllustration className="w-44 h-48 md:w-52 md:h-56" />
              <WalletIllustration className="w-36 h-36 hidden md:block self-center" />
            </motion.div>
            <motion.div
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center mb-16">
            <motion.div
              ...
              className="bg-card rounded-2xl p-8 gold-border-glow card-3d"
            >
              ...
              <div className="space-y-4">
                {investSteps.map((step, i) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0 text-primary font-bold text-sm transition-all duration-300 group-hover:bg-primary/20 group-hover:shadow-[0_2px_12px_hsla(35,85%,48%,0.15)]">
                      {step.num}
                    </div>
          ...
          >
            {investorTypes.map((type, i) => (
              <motion.span
                ...
                className="px-6 py-3 rounded-full bg-card gold-border-glow text-sm font-medium text-foreground card-3d cursor-default"
              >
                {type}
              </motion.span>
            ))}
